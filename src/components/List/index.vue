<template>
	<div class="list">
		...
		<div class="list-content">
			<div class="item" v-for="item in list" :key="item.id" @click.stop="_to(item)">
				<div class="avatar">
					<!--常规展示-->
					<img class="lazyload" :style="{width: imgWidth+'px',height: imgHeight+'px'}" src="/lazy.webp" :data-src="_dataSrc(item)" :alt="item.name">
