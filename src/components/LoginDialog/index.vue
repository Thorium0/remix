<template>
	<div class="login-dialog absolute w-screen h-screen top-0 left-0 z-50 flex justify-center items-center">
			...
			<div class="w-full md:w-1/2 flex flex-col items-center bg-white py-5 md:py-8 px-4">
				...
				<form action="#" class="px-3 flex flex-col justify-center items-center w-full gap-3">
					...
					<input
						...
						class="px-4 py-2 w-full rounded border border-gray-300 shadow-sm text-base placeholder-gray-500 placeholder-opacity-50 focus:outline-none focus:border-blue-500"
					>
					<button class="flex justify-center items-center bg-blue-500 hover:bg-blue-600 text-white focus:outline-none focus:ring rounded px-3 py-1" @click="login">
						<svg class="w-5 h-5 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
							<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 16l-4-4m0 0l4-4m-4 4h14m-5 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h7a3 3 0 013 3v1"></path>
						</svg>
						<span class="ml-1 text-lg">Login</span>
					</button>
				</form>
...
export default {
	...
	methods:{
		login(){
			this.$axios({
				url: `/login/cellphone?phone=${this.email}&password=${this.pwd}`,
			}).then((res) => {
